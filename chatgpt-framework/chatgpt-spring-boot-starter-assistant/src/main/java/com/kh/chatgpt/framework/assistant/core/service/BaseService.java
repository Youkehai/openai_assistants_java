...
import com.kh.chatgpt.framework.assistant.config.OpenAIProperties;
import com.kh.chatgpt.framework.assistant.core.constant.RequestUrlEnum;
import com.kh.chatgpt.framework.assistant.core.req.BaseReq;
...
import com.kh.chatgpt.framework.assistant.core.util.HttpClientUtil;
...
public abstract class BaseService {
     ...
     */
    protected String request(RequestUrlEnum requestUrlEnum, BaseReq reqVO, String... pathArgs) {
        String url = requestUrlEnum.getUrl(properties.getBaseurl(),pathArgs);
        try {
     ...
     * 统一请求方法的重载
     */
    protected String request(RequestUrlEnum requestUrlEnum, String... pathArgs) {
        return request(requestUrlEnum, BaseReq.empty(), pathArgs);
    }
     ...
     * @return 请求参数
     */
    protected String requestByPage(RequestUrlEnum requestUrlEnum, PageReq pageReqVO, String... pathArgs) {
        String url = requestUrlEnum.getUrl(properties.getBaseurl(),pathArgs);
